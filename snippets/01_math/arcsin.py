def arcsin(df, some_numeric_col: str, result: str):
    """
    ...
    :param some_numeric_col: Name of the column whose sine values are to be calculated.
    :param result: Name of the resulting column where the arcsine values will be stored.
    """
    import numpy as np
    df[result] = np.arcsin(df[some_numeric_col])
