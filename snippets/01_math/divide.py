def divide(df, first_col: str, second_col: str | None, some_number: float | None, result: str):
    """
    Divide a column with another column, or with a number.
    ...
    if second_col:
        ...
        import numpy as np
        df[result] = np.divide(df[first_col], some_number)
