def heaviside(df, some_numeric_col: str, x2: float, result: str):
    """
    Applies the Heaviside step function to values in a column.
    :param some_numeric_col: Name of the column to apply the function to.
    ...
    df[result] = np.heaviside(df[some_numeric_col], x2)
    return df
