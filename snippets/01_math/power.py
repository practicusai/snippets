def power(df, numeric_col: str, power_num: int, result: str):
    """
    Raises values in a column to a specified power.
    :param numeric_col: Name of the column containing the values to raise to a power.
    ...
    df[result] = df[numeric_col] ** power_num
    return df
