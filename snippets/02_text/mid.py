def mid(df, some_text_col: str, start_position: int, number_of_characters: int, result: str):
    """
    ...
    :param some_text_col: Name of the column containing strings to extract characters from.
    ...
    """
    df[result] = df[some_text_col].str.slice(start_position, start_position + number_of_characters)
