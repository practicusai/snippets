def slice_replace(df, text_col: str, start: int, stop: int, replacement: str, result: str):
    """
    ...
    :param text_col: Name of the column containing text strings to be processed.
    ...
    """
    df[result] = df[text_col].str.slice_replace(start, stop, replacement)
