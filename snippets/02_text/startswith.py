def startswith(df, some_text_col: str, text: str, result: str):
    """
    ...
    :param some_text_col: Name of the column to check for the start of each string element.
    ...
    """
    df[result] = df[some_text_col].str.startswith(text)
